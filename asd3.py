...
class Elementos:
    def __init__(self,nodo1,nodo2,longitud,E=1.232*10**8,A0=1.395*10**-3):
...
for i in np.arange(0,len(ArchivoElementos),1):
    ...
    ListaElementos[i].Datos=np.copy(ArchivoElementos[3:5])
    ListaElementos[i].Plotear3D()
...
#OPCIONES: 
#    · Grados de Libertad(DOF): [Traslación X, Traslación Y, Rotación Z]
#    · ENLACE SIMPLE ENTRE DOS ELEMENTOS. DOF [1,1,1]
#    · FONDEO;  RESTRICCIÓN DE DOF [0,0,1]
#    · BOYA; DOF: [1,F.HIDROSTÁTICA(),1]
